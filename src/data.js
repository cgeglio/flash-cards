const prototypeData = [{
  ...
  "id": 4,
  "question": "What type of prototype method does not modify the existing array\
   but returns a particular representation of the array?",
  "answers": ["mutator method", "accessor method", "iteration method"],
  ...
  "id": 10,
  "question": "Which iteration method returns the first array element where the\
  ...
  "id": 14,
  "question": "Which iteration method can turn an array into a single value of\
   any data type?",
  ...
  "answers": ["boolean", "an array of the same length", "a single value of any\
   data type"],
  "correctAnswer": "boolean"
}, {
  "id": 20,
  ...
  "id": 22,
  "question": "Which prototype method is used to iterate over each property of\
   an object?",
  "answers": ["Object.keys()", "Object.values()", "reduce()"],
  "correctAnswer": "Object.keys()"
}, {
  "id": 23,
  "question": "Which prototype method can make a copy of a pre-existing object\
   or merge two or more objects together?",
  ...
  "id": 26,
  "question": "shift(), unshift(), pop(), and push() are examples of what type\
   of array property method?",
  "answers": ["mutator method", "accessor method", "iteration method"],
  "correctAnswer": "mutator method"
}, {
  "id": 27,
  ...
  "id": 28,
  "question": "Which prototype method returns an array of an object's property\
   values?",
  "answers": ["Object.keys()", "Object.values()", "Object.assign()"],
  "correctAnswer": "Object.keys()"
}, {
  "id": 29,
  "question": "map() takes in two optional arguments: the index of the current\
   element, and the array that map was called upon",
  "answers": ["true", "false"],
  "correctAnswer": "true"
}, {
  "id": 30,
  "question": "What type of methods are functions that allow you to manipulate\
   the value of a particular data type or class?",
